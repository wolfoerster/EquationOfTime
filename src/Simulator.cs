...
namespace EquationOfTime
{
    ...
    public class Simulator
    {
        ...
        /// <summary>
        /// The simulation start time in seconds after refTime.
        /// </summary>
        double timeStart;

        /// <summary>
        /// The actual simulation time in seconds after refTime + timeStart.
        /// </summary>
        double time;
        ...
        {
            time = 0;
            timeStart = (new DateTime(2014, month, day) - refTime).TotalSeconds;
            timeStart -= demoMode ? 900 : 1800; //--- correct to something before midnight
                    ...
                    case Phases.AfterMidnight:
                        {
                            ...
                            else
                            {
                                ...
                                DateTime now = refTime.AddSeconds(timeStart + corrTime);
